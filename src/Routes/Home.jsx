        ...
        <Div>
            ...
            <div className="mx-auto mt-4 m-5">
                ...
                <div className="container-lg d-flex mx-auto flex-column flex-md-row justify-content-center align-items-stretch align-items-center">
                    ...
                    <Card className="my-2 mx-md-2">
                        ...
                        <Card.Body>
                            ...
                            <Card.Link className="btn btn-outline-warning" href="/courses/">
                                Learn More...
                            </Card.Link>
                        </Card.Body>
                        <Card.Footer>
                    ...
                    <Card className="my-2 mx-md-2">
                        ...
                        <Card.Body>
                            ...
                            <Card.Link className="btn btn-outline-warning">
                                Learn More...
                            </Card.Link>
                        </Card.Body>
                        <Card.Footer>
                ...
                <div className="text-center my-3">
                    <Link className="" to="courses">
                        <SlideButton className="fs-5" height={"50px"} width="250px">Explore more courses...</SlideButton>
                    </Link>
                </div>
            </div>
                    ...
                    <div className="row text-white p-2 p-md-5 py-4">
                        <div className="container-lg col-12 col-md-6 d-flex flex-column justify-content-center">
                            ...
                            <p className="text-center text-md-left">
                                ...
                                Institute and is located at Quarry Area, Abeokuta recognized
                                for offering specialist training. We provide a diploma as well
                                as certification training courses in the field of Web
                                Designing, Software Development, Web Development and more. Our
                                training course curriculum is planned to equip you with
                                ...
                                corporate and also specific clients. We have numerous training
                                courses to provide, depending upon the requirements and also
                                choices of our clients. Any individual could select the very
                                best training course based on their requirements and also
                                interests to become a specialized individual in that specific
                                area.
                            </p>
                        </div>
            ...
            <div className="container-fluid px-md-5 bg-light my-5">
                <CategoryPrev
                    ...
                    header="Web Development Courses"
                />
            </div>
            ...
            <div className="position-relative container-fluid p-5 my-5  text-light">
                <WavyBg />
                <div className="container-lg">
                    <h1 className='display-3 text-center' style={{ fontFamily: "Phudu, oswald, Verdana", fontWeight: "400" }}>Data Structures And Algorithm</h1>
                    <div className="row my-5 align-items-center text-center">
                        <div className='col-12 col-md-6'>
                            <DbImg width={"100%"} height={"100%"} />
                        </div>
                        <div className='fs-3 col-12 col-md-6'>
                            <p>Data structure and algorithms are two of the most important aspects of computer science. Data structures allow us to organize and store data, while algorithms allow us to process that data in a meaningful way. Learning data structure and algorithms will help you become a better programmer.</p>

                        </div>
                    </div>
                    <div className="text-center">
                        <Link to={"/courses/web-development/data-strucutures-and-algorithm"}><button className='text-info fw-bold fs-5 btn btn-outline-info rounded-pill px-5 py-3'>Explore now...</button></Link>
                    </div>
                </div>
            </div>
